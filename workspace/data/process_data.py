...
def load_data(messages_filepath, categories_filepath):
    ...
    Return:
    df (DataFrame): A datafram of messages and categories
    """
...
def clean_data(df):
    ...
    Args:
    df (DataFrame): A datafram of messages and categories need to be cleaned
    
    Return:
    df (DataFrame): A cleaned datafram of messages and categories
    """
